...
import com.doll.pay.WXPayConstants.SignType;
...
//        }
    ...
    public Map<String, String> jsapiSign(Map<String, String> reqData) throws Exception {
        reqData.put("appId", config.getAppID());
        reqData.put("timestamp", Long.toString(WXPayUtil.getCurrentTimestamp()));
    ...
    public Map<String, String> jsapiSignApp(Map<String, String> reqData) throws Exception {
        reqData.put("appid", config.getAppID());
